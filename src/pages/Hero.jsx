...
const Hero = () => {
    ...
    return (
        ...
        >
            ...
            {/* Text Section */}
            <div className={`max-w-lg space-y-6 text-center lg:text-left ${darkMode ? 'text-white' : 'text-black'}`}>
                <motion.h1
                    className={`text-5xl font-extrabold ${darkMode ? 'text-purple-300' : 'text-purple-700'}`}
                    {...fadeInUp()}
                >
                    Hi, I am <span className="text-purple-400">Rudra Protap Chakraborty</span>
                </motion.h1>
                <motion.h2
                ...
                <motion.p
                    className={`text-gray-300 leading-relaxed ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}
                    {...fadeInUp(0.4)}
                >
                    I specialize in creating visually engaging and highly responsive web interfaces using the latest technologies. With a keen eye for detail and a passion for clean design, I craft user-friendly digital experiences that drive results.
                </motion.p>
                <a
                    target="_blank"
