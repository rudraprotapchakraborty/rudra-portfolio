...
const Footer = () => {
    ...
    return (
        <footer
            className={`${darkMode ? 'bg-black bg-opacity-80 text-gray-300' : 'bg-white text-gray-800'
        ...
        >
            <div className="container mx-auto py-12 px-6 md:px-12 flex flex-col md:flex-row justify-between items-center gap-8">
                ...
                <div className="text-center md:text-left flex flex-col md:flex-row items-center md:gap-4">
                    ...
                    <div>
                        <h1
                            className={`text-3xl font-semibold ${darkMode ? 'text-white' : 'text-black'
                                }`}
                        >
                            Rudra Protap Chakraborty
                        </h1>
                        <p
                            className={`text-lg mt-2 ${darkMode ? 'text-gray-400' : 'text-gray-600'
                                }`}
                        >
                ...
                <div className="flex flex-wrap gap-6 justify-center mt-6 md:mt-0">
                    <a
                        href="#home"
                        className={`hover:text-purple-400 text-lg transition duration-300 ease-in-out transform hover:scale-110 ${darkMode ? 'text-gray-300' : 'text-gray-800'
                            }`}
                    >
                        Home
                    </a>
